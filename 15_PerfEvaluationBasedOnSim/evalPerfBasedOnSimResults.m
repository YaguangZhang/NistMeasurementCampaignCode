...
if exist(pathToSavePredictionsForGrid, 'file')
    ...
    numOfCleanedMeasPts = sum(allBoolsToKeepMeas);
    estiDistsNotInWoodland = nan(numOfCleanedMeasPts, 1);
    for idxMeasPt = 1:numOfCleanedMeasPts
