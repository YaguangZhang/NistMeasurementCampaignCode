...
% pixels in the zone on the vegetation map and use that as the foliage
% area.
...
if exist(pathToSaveModelInfo, 'file')
    ...
    for idxTrack = 1:numTracks
        ...
        curNumFoliagePixelsInFirstFresnelZone = nan(numSamps, 1);
...
% For the constant losses for each trunk and each unit of foliage area in the first Fresnel zone model.
fctToFit = @(parasToFit, inputs) ...
