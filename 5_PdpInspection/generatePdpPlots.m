...
energyRatiosForLosSig ...
    ...
    timeMsInPlots, signalAmpInPlots, fullPathsToSaveEnRatioPlots);
...
cellfun(@(idxTrack) ...
    ...
    idxTrack, sampIndexRanges{idxTrack}, p, axisToSet), ...
    1:length(sampIndexRanges), fullPathsToSaveMapPlots);
