...
for idxS = 1:numOfSeries
    ...
    for idxSamp = 1:curNumSamps
        ...
        % Compute the weighted number of trunks in the first Fresnel zone.
...
ylabel(hPlot3kColorbar, 'Number of Trunks in the 1st Fresnel Zone ');
...
% Constantly shifted free-space path losses.
plot3k([sortedLosDist allNumsOfTreesInFirstFresnel(indicesForSortedDist) ...
