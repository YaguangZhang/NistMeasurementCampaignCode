...
# Title: Rxwithgpsref
# Generated: Sat Mar 31 10:08:41 2018
##################################################
...
class rxWithGpsRef(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Rxwithgpsref")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rxwithgpsref")
        ...
        self.settings = Qt.QSettings("GNU Radio", "rxWithGpsRef")
...
def main(top_block_cls=rxWithGpsRef, options=None):
