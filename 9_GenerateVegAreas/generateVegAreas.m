...
ABS_PATH_TO_SAVE_PLOTS = fullfile(ABS_PATH_TO_NIST_SHARED_FOLDER, ...
    'PostProcessingResults', 'ManuallyDrawVegAreas');
...
if exist(ABS_PATH_TO_SAVE_VEG_AREAS_META, 'file')==2
    ...
    VEG_AREA_IMG_GPS_LATS = nan(VEG_AREA_IMG_RESOLUTION);
    
    % Also, we will generate memoization tables for quickly fetch the GPS
    ...
    for curMinTreeH = minTreeHs
        ...
        plot_google_map('Maptype', 'satellite'); view(2);
